import metaImage from "./jaimie-phillips-KamSS2euCzA-unsplash.jpg";
...
<i class="fa fa-exclamation-circle" aria-hidden="true"></i> We should make sure to
sanity check our matrix dimensions before going any further! It will save you a lot
