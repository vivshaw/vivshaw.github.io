...
import { faBars, faEnvelope, faRss, faXmark } from "@fortawesome/free-solid-svg-icons";
    ...
    >
      ...
      <div className={styles.section}>
        ...
        <ul className={styles.navList}>
          ...
          <li>
            <a className={styles.navLink} href={author.zettelkasten} onClick={close}>
              zettel
            </a>
          </li>
          <li>
      ...
      <div className={styles.socialSection}>
        <ul className={styles.socialList}>
          ...
          <li>
            <Pill as="a" href={author.socials.github} target="_blank" rel="noopener noreferrer">
              <FontAwesomeIcon icon={faGithub} />
              github
            </Pill>
          </li>
          <li>
            <Pill as="a" href={author.socials.bluesky} target="_blank" rel="noopener noreferrer">
