 ...
 */
export function MdxBody({ className, children, leadingSmallCaps }: MdxBodyProps) {
  return (
    <article className={clsx(styles.body, leadingSmallCaps && styles.leadingSmallCaps, className)}>
      {children}
    </article>
  );
}
