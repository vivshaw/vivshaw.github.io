...
export type PillProps<T extends ElementType = "span"> = ComponentPropsWithRef<T> & {
  as?: T;
};
 ...
 */
export function Pill<T extends ElementType = "span">({ as, className, ...props }: PillProps<T>) {
