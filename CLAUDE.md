...
- @.cursor/rules/basalt.mdc - for developing the Basalt design system
- @.cursor/rules/use-basalt.mdc - information for using the Basalt design system to build UI
- @.cursor/ruels/code-style.mdc - code style rules
